...
| Campo | Valor |
| :-- | :-- |
| Revisión de la memoria | **r71** |
| Fecha de la revisión | 2026-09-24 |
| Versión de la app | **2.0.3** (r71: firma manuscrita r68, fuentes de Texto r69, presentación r70 y titular/licencia r71; `window_menus.APP_VERSION`, `APP_OWNER`, `APP_REPO`) |
...
46. **(r26) Panel lateral = rail + `column` (opciones `tools` arriba, `stack`
    ...
    las pruebas, abrir antes un panel (`show_panel`): con el `stack` oculto
    las posiciones verticales no significan nada. Al abrir la columna con el
