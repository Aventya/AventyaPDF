...
| Campo | Valor |
| :-- | :-- |
| Revisión de la memoria | **r82** |
| Fecha de la revisión | 2026-09-25 |
| Versión de la app | **2.0.4** (sin reempaquetar desde r72: r73-r79 varios (aviso de firma, paneles Firma/Comprimir, Firmas Certificadas, búsqueda en la barra principal); r80/r81/r82 son tres intentos sucesivos de arreglar el fantasma negro al arrastrar una miniatura (`devicePixelRatio` → alfa premultiplicado → **sin alfa, opaco**) — **r82 sigue sin confirmar en la pantalla real de Ricardo**, las diez pendientes de versión/instalador nuevos; 2.0.3 en r71: firma manuscrita r68, fuentes de Texto r69, presentación r70 y titular/licencia r71; `window_menus.APP_VERSION`, `APP_OWNER`, `APP_REPO`) |
