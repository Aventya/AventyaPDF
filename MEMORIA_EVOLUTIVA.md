...
| Campo | Valor |
| :-- | :-- |
| Revisión de la memoria | **r72** |
| Fecha de la revisión | 2026-09-24 |
| Versión de la app | **2.0.4** (r72: opciones de herramienta arriba del panel lateral; 2.0.3 en r71: firma manuscrita r68, fuentes de Texto r69, presentación r70 y titular/licencia r71; `window_menus.APP_VERSION`, `APP_OWNER`, `APP_REPO`) |
